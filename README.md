...
from the Gleam stdlib under a uniform naming scheme. Alternative to [given](https://hex.pm/packages/given).

[API digest.](#table-comparison-between-on-stdlib-and-given)
